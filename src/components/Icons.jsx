export const SecIcon = {
  Hat: (p) => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
      <path d="M12 3 2 9l10 4 10-4-10-6z"/><path d="M6 10.5V15c0 2 3 3.5 6 3.5s6-1.5 6-3.5v-4.5"/>
    </svg>
  ),
  Whack: (p) => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
      <circle cx="6" cy="18" r="2.5"/><circle cx="18" cy="6" r="2.5"/><circle cx="18" cy="18" r="2.5"/><circle cx="6" cy="6" r="2.5"/>
      <path d="m10 8 4 8"/>
    </svg>
  ),
  Clock: (p) => (
...
export const Icon = {
  ...
  Sparkles: (p) => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
      <path d="M12 3l1.9 4.7L18.5 9l-4.6 1.9L12 15l-1.9-4.1L5.5 9l4.6-1.3z"/>
      <path d="M19 15l.9 2 2.1.6-2.1.6L19 20l-.9-1.8L16 17.6l2.1-.6z"/>
    </svg>
  ),
  Star: (p) => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="1" {...p}>
